# Agent Thread 8: Funding and Capital Plan
...
|----------|--------|---|---------|
| **Team** | $390,000 | 60% | Founder salary $150k; delivery engineer from M4–5 $120k; fractional sales $40k; buffer |
| **GTM** | $130,000 | 20% | Vertical events, founding subsidies, demo travel, content |
| **Platform** | $35,000 | 5% | SSO scaffold, runbook automation, QuickStart hardening |
| **Compliance** | $25,000 | 4% | Legal templates, insurance, basic security docs (IRAP deferred) |
| **Cloud / demos** | $30,000 | 5% | Multi-tenant POC environments |
| **Reserve** | $40,000 | 6% | Contingency |
| **Total** | **$650,000** | **100%** | |
...
|-------|-----------|----------|-------------------------|
| 1 | QuickStart runbook documented | Thread 7 playbook | ~$35k |
| 2–3 | First paid QuickStart | Signed SOW + deposit | ~$70k |
| 6 | 4 QuickStarts completed | CRM + case study draft | ~$210k |
| 6 | Delivery engineer hired | Employment agreement | — |
| 9 | 2 Team Production conversions | Deploy SOWs | ~$315k |
| 12 | 8 pilot logos; $60k+ ARR | Support contracts | ~$421k opex |
| 12 | Operating cash positive (base case) | P&L | Net cash ~$792k with raise |
| 14–18 | Seed raise | Term sheet | — |
| 18 | 10+ logos; $350–500k ARR | Data room | Seed milestones |

---

## Revenue vs Burn (Base Case, Track A)

| Month | Cumulative revenue | Cumulative opex | Net position (with $650k) |
|-------|-------------------|-----------------|---------------------------|
| 3 | $24k | $105k | ~$569k |
| 6 | $96k | $210k | ~$536k |
| 9 | $210k | $315k | ~$545k |
...
| Pre-money | $7–8M |
| Dilution | ~16–19% |
| Use | 30% sales, 28% delivery, 12% CS, 10% marketing, 8% platform, 6% compliance, 6% G&A |

**Seed story:** Productised sovereign AI for mid-market; 12 logos, $400k ARR, 45% conversion, 5-day deploy.

---

## Bootstrap Fallback Plan

If pre-seed does not close **and** Adneo SOW fails **and** no angel interest:

| Phase | Action |
|-------|--------|
| Trigger | Adneo unsigned + $0 angel commitments → stop or pivot (consulting / employment bridge) |
| Alternative (pre-trigger) | Angel note $100–300k from 2–3 angels for 6-month bridge |
...
| # | Investor / fund | Type | Thesis fit | Warm path | Status |
|---|-----------------|------|------------|-----------|--------|
| 1 | | Angel / pre-seed | B2B services, govtech, AI infra | | |
| 2 | | | | | |
| 3 | | | | | |
| 4 | | | | | |
| 5 | | | | | |

**AU investors to research:** Blackbird (if intro), Airtree scouts, Skalata, Antler alumni, sector angels in legal tech / cybersecurity.

**FOUNDER INPUT:** Complete with real names and intro paths.

---

## Traction Narrative for Pre-Revenue Raise

What you can credibly show **before** first paid customer:

| Asset | Investor value |
|-------|----------------|
| Working POC + desktop UX | Technical de-risking |
| Profile-switch architecture (POC → on-prem) | Migration story without rebuild |
| Track A GTM with fixed pricing | Capital-efficient model |
| Competitor matrix | Market validation |
| Founder technical credibility | Delivery risk reduced vs pure services shop |

What you should aim to show **during** raise process:

- 3+ fit calls completed
- 1+ proposal in negotiation
- LOI or verbal commit (not counted as logo)

---

## Investor Memo (2-Page Summary)

### Company

Sovereign Warden deploys ChatGPT-class AI on infrastructure the customer owns — for Australian mid-market firms (50–250 employees) that cannot use public AI with client data.

### Problem

Shadow ChatGPT use; Copilot costs $27k+/yr for 50 users; AU sovereign competitors take 8–14 weeks to pilot.

### Solution

Productised platform (AnythingLLM + LiteLLM + Qdrant): **5-day QuickStart**, fixed $12–35k pricing, path to on-prem without code changes.

### Market

~10,000–17,000 regulated mid-market organisations in AU (Track A SAM). Year 1 wedge: mid-tier law and accounting.

### Business model

Paid pilot → production → annual support. 3-year LTV ~$121k; founder-led CAC $3–5k.
...
8 logos, 3 production customers, $60k+ ARR, QuickStart &lt;5 days, seed-ready at $350k+ ARR.
